...
class EditpasswordAction extends BaseAction{
	protected function beforeAction(){
        ...
        $this->controller->tag="editpassword";
        $this->controller->breadcrumbs=array('用户中心'=>$this->controller->createUrl("index"),'修改密码');
        $this->controller->set_seo('修改密码','','');
        return true;
    }
   protected function do_action(){
      ...
      $model->attributes=$_POST[$model_name];
		...
		$this->display('edit_password',array('model'=>$model));
  }
