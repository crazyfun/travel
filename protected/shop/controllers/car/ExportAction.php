...
class ExportAction extends  BaseAction{
    ...
    protected function do_action(){
       ...
       if(!empty($create_id)){
    	...
    	$model_datas=$model->with("User","Motorcade")->findAll(implode(" AND ",$conditions),$params);
