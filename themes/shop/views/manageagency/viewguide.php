        ...
        <div class="edit_content edit_table">
                 <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td width="191" valign="top" align="center" rowspan="11" style="vertical-align:middle;" class="portrait_td"><div class="portrait_con"><?php if(!empty($model->guide_pass)){ $thumb_image=Util::rename_thumb_file('180','450','',$model->guide_pass);echo CHtml::image("/".$thumb_image,$model->User->real_name,array());}else{echo CHtml::image($cssPath."/images/logo.gif",$model->User->real_name,array());}?></div></td>
