       <div class="edit_table">
                 <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td width="191" valign="top" align="center" rowspan="11" class="portrait_td"><div class="portrait_con"><?php $thumb_image=Util::rename_thumb_file('180','450','',$model->agency_logo);echo CHtml::image("/".$thumb_image,$model->agency_name,array());?></div></td>
