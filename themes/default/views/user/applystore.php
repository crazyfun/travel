                <?php
                    Yii::app()->clientScript->registerCssFile("/js/jbox/Skins2/Green/jbox.css");
				       ...
				       ?>
                <div class="page-right-top">申请商铺</div>
                <div class="right_tab_con">
                  ...
                  <div class="input_line"><div class="input_name"><span class="input_required"></span>VIP商铺:</div><div class="input_content"><?php echo $form->createSelect($model,"is_vip",CV::$store_vip,array());?></div><div class="content_error"><?php echo $form->error($model,"is_vip");?></div><div class="input_tip"></div></div>
                  ...
                  <div class="input_line"><div class="input_button"><?php echo CHtml::submitButton("申请",array('class'=>'save_bt'));?><?php echo CHtml::resetButton("重置",array('class'=>'save_bt'));?></div></div>
               		<?php $this->endWidget(); ?>
            	</div>   	
