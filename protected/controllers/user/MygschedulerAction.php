<?php
class MygschedulerAction extends BaseAction{
   ...
   protected function do_action(){
  	 ...
  	 //生成ActiveDataProvider对象
	 	...
	 	$dataProvider=new CActiveDataProvider($model, array(
			...
			'params'=>$params,
			'with'=>array("User"=>array('with'=>array('TravelAgency')),"AgencyDate"),
			),
			'pagination'=>array(
			'pageSize' => '20',
			'params' => $page_params,
		...
		$this->display('my_gscheduler',array('dataProvider'=>$dataProvider,'page_params'=>$page_params));
  }
