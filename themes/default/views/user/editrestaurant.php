    	  ...
    	  ?>
        <div class="page-right-top">酒店信息修改</div>
        <div class="right_tab_con edit_table">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td width="191" valign="top" align="center" rowspan="10" class="portrait_td"><div>酒店图片(Logo)</div><div class="portrait_con"><?php echo $form->createFile($model,"restaurant_logo",array('is_cope'=>false));?></div><div class="error_tableinput"><?php echo $form->error($model,"restaurant_logo");?></div></td>
