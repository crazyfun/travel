        ...
        <div class="page-right-top">导游信息修改</div>
        <div class="right_tab_con edit_table">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td colspan="6" height="30" align="center" class="edit_table_top"><div class="no_card_list_top"><div class="card_title_name"><b>导游员 <span><?php echo $model->User->real_name;?></span>信息修改</b></div></div></td>
                        </tr>
                        <tr>
