...
/**
 * This is the model class for table "{{scustoms}}".
 *
 * The followings are the available columns in table '{{scustoms}}':
 * @property string $id
 ...
 */
class Scustoms extends BaseActive
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Scustoms the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, cell_phone, email, msn', 'length', 'max'=>30),
			...
			array('id, name, sex, cell_phone, email, qq, msn, code, address, comment, station_id, create_id, create_time', 'safe', 'on'=>'search'),
		);
	}
