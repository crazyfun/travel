...
class ExportAction extends  BaseAction{
    ...
    protected function do_action(){
    	...
    	$conditions=array();
    	$params=array();
    	$invoice_numbers=$get['invoice_numbers'];
       if(!empty($invoice_numbers)){
		   ...
		   $order_numbers=$get['order_numbers'];
       ...
       if(!empty($end_date)){
		   ...
		   $shenhe_start_date=$get['shenhe_start_date'];
       if(!empty($shenhe_start_date)){
		   ...
		   $shenhe_end_date=$get['shenhe_end_date'];
