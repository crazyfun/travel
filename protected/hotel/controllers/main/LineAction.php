...
class LineAction extends  BaseAction{
    ...
    protected function do_action(){
    	  ...
    	  $model_datas=$model->findAll(array('select'=>'id,line','condition'=>"line LIKE :line AND station_id=:station_id",'params'=>array(':line'=>"%".$query."%",':station_id'=>$station_data['id'])));
    	  $suggestions=array();
    	  $data=array();
    	  foreach($model_datas as $key => $value){
    	  	array_push($suggestions,$value->line);
    	  	$tem_data=array();
