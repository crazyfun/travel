<div class="linksbox"><!--友情链接-->
    	<dl class="linksmain">
            ...
            ?>
			                 <dd id="flink_<?php echo $value['id'];?>" class="flink_item" <?php if($key==0) echo "style='display:block;'";?>>
            	  					<ul>
            	  						<?php  foreach($link_datas as $key1 => $value1){ ?>
                						     <li><a  href="<?php echo $value1['friendlink_href'];?>" target="_blank" ><?php echo $value1['friendlink_name'];?></a></li>
                					  <?php } ?>
                					</ul>
            					</dd>
			       <?php } ?>    
