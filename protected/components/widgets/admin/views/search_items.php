      ...
      <!--搜索操作-->  
       <div class="search_content">
           ...
           echo CHtml::beginForm("","post",array());
		    ...
		    ?>
			       <div class="search_item"><span class="search_item_name"><?php echo $value['name'];?>:</span><span class="search_item_input"><?php if($value['type'] == 'multitext') EHtml::selectCreate($value['type'],$key,$value['select'],$value['value'],$value['htmlOptions']);else echo EHtml::selectCreate($value['type'],$key,$value['select'],$value['value'],$value['htmlOptions']); ?></span></div>
		    <?php } ?>
