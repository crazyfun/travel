<?php
class EdittousuAction extends BaseAction{
  ...
  protected function do_action(){	
      ...
      if(empty($_POST[$model_name]['id'])){
         $model->relation_id=$relation_id;
			...
			$dijieshe_obj=new Dijieshe();
			$dijieshe_data=$dijieshe_obj->findByPk($relation_id);
			$station_id=$dijieshe_data->station_id;
		...
		$this->display('addtousu',array('model'=>$model,'relation_id'=>$relation_id));
  } 
}
?>
