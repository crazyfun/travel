<?php
class SettleeAction extends BaseAction{
  ...
  protected function do_action(){	
    $model=new DijiesheJiesuan();
      ...
      $model->attributes=$_POST[$model_name];
		  ...
		  $order_data=$order->with("Dijieshe")->findByPk($model->order_id);
		}else{
			$id=$_REQUEST['id'];
		...
		$this->display('settlee',array('model'=>$model,'order_data'=>$order_data));
  } 
}
?>
