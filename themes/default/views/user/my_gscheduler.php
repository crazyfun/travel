...
function get_scheduler_datas(year,month){
	jQuery.getJSON("/api/myguidecalendar", { year: year, month: month }, function(json){
  			if(json.flag=='y'){
  				var guide=json.datas.guide;
					...
					for(var i = 1, len = monthDay; i <= len; i++){
						...
						var innerhtml="<div class='date_item'>"+i+"</div>";
...
jQuery.jBox("iframe:/user/viewguideordain?id="+ordain_id, {
    title: "查看预定信息",
    width: 800,
    height: 500,
    buttons: { '关闭': true }
