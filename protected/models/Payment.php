...
class Payment extends BaseActive
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pay_id, pay_code, pay_name, pay_fee, pay_desc, pay_config, enabled', 'safe', 'on'=>'search'),
		);
	}
	...
	function get_real_amount($pay_code,$amount){
		$payment_data=$this->find("pay_code=:pay_code",array(':pay_code'=>$pay_code));
