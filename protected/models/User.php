...
class User extends BaseActive{
	...
	public function rules()
	{
      ...
      array('user_login,real_name,user_email,user_password','required','message'=>'{attribute}不能为空','on'=>'WebRegiste'),
	...
	public function relations(){
		...
		return array(
		 ...
		 'TravelAgency'=>array(self::HAS_ONE,'TravelAgency','user_id'),
		 'Guide'=>array(self::HAS_ONE,'Guide','user_id'),
		 'Station'=>array(self::BELONGS_TO, 'Station', 'station_id'),
		 'GuideDate'=>array(self::HAS_MANY,'GuideDate','user_id'),
		);
	}
...
//̨û¼
  ...
  /*
	...
	*/
	public function show_user_permissions(){
	 ...
	 //获取分站的用户选择框
 public function get_user_station($station_id=""){
   ...
   $user_select=array();
   $user_datas=$this->findAll($condition,$params);
 ...
 public function get_invite_link($invite_code=""){
 	  $invite_code=empty($invite_code)?$this->invite_code:$invite_code;
    return Yii::app()->homeUrl.Yii::app()->getController()->createUrl("/registe/registe/index",array('invite_code'=>$invite_code));
 }
