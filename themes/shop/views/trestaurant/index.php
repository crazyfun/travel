<?php 
       ...
       $environment=Util::com_search_item(array(''=>'环境'),CV::$environment);
       ...
       $this->widget('SearchItems', array( 
          ...
          'search_datas'=>array(
             ...
             'cell_phone'=>array(
              ...
              'environment'=>array(
               'name'=>'环境',
               'type'=>'select',//搜索框的类型
               'select'=>$page_params['environment'],
               'value'=>$environment,
               'htmlOptions'=>array(),
             ),
          ...
          'attributes'=>array(
             ...
             array(
              ...
              array(
                'name'=>'environment',
                'type'=>'raw',
                'value'=>'$data->show_attribute("environment")',
              ),
             array(
                'name'=>'cell_phone',
                'type'=>'raw',
          ...
          'operates'=>array(
             ...
             array(
               ...
               'value'=>"javascript:excel_import('".$this->createUrl('import')."','Restaurant');"              
             ),
             
             
             array(
               'name'=>CHtml::image($css_path."/images/excelc.gif","",array('style'=>'border:0;')),
               'value'=>"javascript:excel_export('".$this->createUrl('export')."','Restaurant','".$excel_params."');"              
             ),
          ),
          //是否需要全选列
          'checked_all'=>true,
