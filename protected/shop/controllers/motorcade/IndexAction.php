...
class IndexAction extends BaseAction{
  ...
  protected function do_action(){	
       ...
       if(!empty($motorcade_name)){
			   array_push($conditions,"t.motorcade_name LIKE :motorcade_name");
			   $params[':motorcade_name']="%$motorcade_name%";
			   $page_params['motorcade_name']=$motorcade_name;
		   }
		   
		   $motorcade_contacter=$_REQUEST['motorcade_contacter'];
       if(!empty($motorcade_contacter)){
			   array_push($conditions,"t.motorcade_contacter LIKE :motorcade_contacter");
			   $params[':motorcade_contacter']="%$motorcade_contacter%";
			   $page_params['motorcade_contacter']=$motorcade_contacter;
		   }
