<?php
class AddguidedateAction extends BaseAction{
   ...
   protected function do_action(){
		...
		if($_POST[$model_name]){
			...
			if($model->validate()){
			 ...
			 $new_model=$model->find("date=:current_date AND user_id=:user_id",array(':current_date'=>$current_date,':user_id'=>$user_id));
       $model=empty($new_model)?$model:$new_model;
