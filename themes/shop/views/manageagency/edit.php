        ...
        <div class="edit_content edit_table">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td width="191" valign="top" align="center" rowspan="10" class="portrait_td"><div>旅行社Logo</div><div class="portrait_con"><?php echo $form->createFile($model,"agency_logo",array('is_cope'=>false));?></div><div class="error_tableinput"><?php echo $form->error($model,"agency_logo");?></div></td>
