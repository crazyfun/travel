        ...
        <div class="edit_content edit_table">
                 <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td width="191" valign="top" align="center" rowspan="11" class="portrait_td"><div class="portrait_con"><?php if(!empty($model->restaurant_logo)){ $thumb_image=Util::rename_thumb_file('180','450','',$model->restaurant_logo);echo CHtml::image("/".$thumb_image,$model->restaurant_name,array());}else{echo CHtml::image($cssPath."/images/logo.gif",$model->restaurant_name,array());}?></div></td>
                        ...
                        <tr>
                         ...
                         <tr>
                           ...
                           <td colspan="4" align="right"><a href="<?php echo $this->createUrl("managerestaurant/edit");?>" class="sure_bt_link">修改</td>
                        </tr>
