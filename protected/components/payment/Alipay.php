...
class Alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><input class="tj_bt" type="button" onclick="window.open(\'https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="在线支付" /></div>';
        return $button;
    }
